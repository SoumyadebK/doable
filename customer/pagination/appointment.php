        ...
        while (!$appointment_data->EOF) {
            ...
            <tr onclick="$(this).next().slideToggle();">
                ...
                <td style="text-align: center;">
                    ...
                    <?php } else { ?>
                        <a href="all_schedules.php?id=<?= $appointment_data->fields['PK_APPOINTMENT_MASTER'] ?>&action=complete" data-id="<?= $appointment_data->fields['PK_APPOINTMENT_MASTER'] ?>"><i class="fa fa-check-circle" style="font-size:25px;color:#a9b7a9;"></i></a>
