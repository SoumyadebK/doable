    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="row">
                ...
                <!--<div class="col-6">
                    <div class="form-group">
                        <label class="form-label">Do you want to cancel your Appointment for this Group Class ? <a href="all_schedules.php?view=table&id=<?php /*=$_SESSION['PK_USER']*/?>" onclick='javascript:ConfirmDelete(<?php /*=$_SESSION['PK_USER']*/?>);return false;'><img src="../assets/images/noun-cancel-button.png" title="Cancel" style="height: 20px; width: 20px"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                    </div>
                </div>-->
            </div>
        </div>
