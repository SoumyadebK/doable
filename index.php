...
<head>
    ...
    <link rel="stylesheet" type="assets/homepage/text/css" href="assets/homepage/fonts/Simple-Line-Icons-Webfont/simple-line-icons.css" media="screen" />
    <link rel="stylesheet" href="assets/homepage/fonts/et-line-font/et-line-font.css">
    <link rel="stylesheet" type="assets/homepage/text/css" href="assets/homepage/js/revolution-slider/css/settings.css">
    <link rel="stylesheet" type="assets/homepage/text/css" href="assets/homepage/js/revolution-slider/css/layers.css">
    <link rel="stylesheet" type="assets/homepage/text/css" href="assets/homepage/js/revolution-slider/css/navigation.css">
    ...
    <link rel="stylesheet" href="assets/homepage/js/ytplayer/ytplayer.css" />
    <link rel="stylesheet" href="assets/homepage/fonts/pe-icon-7-stroke/css/pe-icon-7-stroke.css">
...
<body>
    ...
    <div class="wrapper-boxed">
            ...
            <div class="col-md-12 nopadding">
                <div class="header-section style1 pin-style main-header">
                    <div class="container">
                        <div class="mod-menu">
                            <div class="row">
                                <div class="col-sm-3"> <a href="index.php" title="" class="logo style-2 mar-2"> <img height="80" src="assets/homepage/images/doable_logo.png" alt=""> </a> </div>
                                <div class="col-sm-9">
                                    <div class="main-nav">
     ...
     style="z-index: 7; white-space: nowrap;text-transform: inherit;">is <span class="theme-grn-color-text">DOABLE</span></div> -->
            ...
            <div class="clearfix"></div>
            <!-- end section -->
            <div class="divider-line solid light-1"></div>
            <div class="clearfix"></div>
            <!-- end section -->
    ...
    <script type="text/javascript" src="assets/homepage/js/ytplayer/jquery.mb.YTPlayer.js"></script>
    <script type="text/javascript" src="assets/homepage/js/ytplayer/elementvideo-custom.js"></script>
    <script type="text/javascript" src="assets/homepage/js/ytplayer/play-pause-btn.js"></script>
    <!-- REVOLUTION JS FILES -->
    <script type="text/javascript" src="assets/homepage/js/revolution-slider/js/jquery.themepunch.tools.min.js"></script>
    <script type="text/javascript" src="assets/homepage/js/revolution-slider/js/jquery.themepunch.revolution.min.js"></script>
    <!-- SLIDER REVOLUTION 5.0 EXTENSIONS  
(Load Extensions only on Local File Systems ! 
The following part can be removed on Server for On Demand Loading) -->
    <script type="text/javascript" src="assets/homepage/js/revolution-slider/js/extensions/revolution.extension.actions.min.js"></script>
    <script type="text/javascript" src="assets/homepage/js/revolution-slider/js/extensions/revolution.extension.carousel.min.js"></script>
    <script type="text/javascript" src="assets/homepage/js/revolution-slider/js/extensions/revolution.extension.kenburn.min.js"></script>
    <script type="text/javascript" src="assets/homepage/js/revolution-slider/js/extensions/revolution.extension.layeranimation.min.js"></script>
    <script type="text/javascript" src="assets/homepage/js/revolution-slider/js/extensions/revolution.extension.migration.min.js"></script>
    <script type="text/javascript" src="assets/homepage/js/revolution-slider/js/extensions/revolution.extension.navigation.min.js"></script>
    <script type="text/javascript" src="assets/homepage/js/revolution-slider/js/extensions/revolution.extension.parallax.min.js"></script>
    <script type="text/javascript" src="assets/homepage/js/revolution-slider/js/extensions/revolution.extension.slideanims.min.js"></script>
    <script type="text/javascript" src="assets/homepage/js/revolution-slider/js/extensions/revolution.extension.video.min.js"></script>
    ...
    <script src="assets/homepage/js/magnific-popup/jquery.magnific-popup.js"></script>
    <script type="text/javascript">
