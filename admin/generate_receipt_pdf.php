...
<body>
    ...
    <div id="printContent">
        ...
        $enrollment_payment = $db_account->Execute("SELECT DOA_ENROLLMENT_PAYMENT.*, DOA_PAYMENT_TYPE.PAYMENT_TYPE FROM DOA_ENROLLMENT_PAYMENT LEFT JOIN $master_database.DOA_PAYMENT_TYPE AS DOA_PAYMENT_TYPE ON DOA_ENROLLMENT_PAYMENT.PK_PAYMENT_TYPE = DOA_PAYMENT_TYPE.PK_PAYMENT_TYPE WHERE (DOA_ENROLLMENT_PAYMENT.PK_ENROLLMENT_MASTER = '$PK_ENROLLMENT_MASTER' || (DOA_ENROLLMENT_PAYMENT.PK_ENROLLMENT_MASTER = 0 && DOA_ENROLLMENT_PAYMENT.TYPE = 'Wallet')) AND DOA_ENROLLMENT_PAYMENT.IS_ORIGINAL_RECEIPT = 1 AND RECEIPT_NUMBER = '$RECEIPT_NUMBER'");
