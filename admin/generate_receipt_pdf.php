...
foreach ($RECEIPT_NUMBER_ARRAY as $key => $value) {
    ...
    if ($PK_ENROLLMENT_MASTER == 0) {
        ...
        $enrollment_billing_data = $db_account->Execute("SELECT DOA_ENROLLMENT_BILLING.BILLING_REF FROM DOA_ENROLLMENT_BILLING LEFT JOIN DOA_ENROLLMENT_PAYMENT ON DOA_ENROLLMENT_BILLING.PK_ENROLLMENT_BILLING = DOA_ENROLLMENT_PAYMENT.PK_ENROLLMENT_BILLING WHERE DOA_ENROLLMENT_PAYMENT.RECEIPT_NUMBER = " . $value);
