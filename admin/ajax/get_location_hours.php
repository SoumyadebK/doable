...
echo "SELECT DOA_USER_LOCATION.*, DOA_LOCATION.LOCATION_NAME FROM `DOA_USER_LOCATION` LEFT JOIN DOA_LOCATION ON DOA_USER_LOCATION.PK_LOCATION = DOA_LOCATION.PK_LOCATION WHERE PK_USER = '$PK_USER'";
