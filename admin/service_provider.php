                ...
                <div class="col-md-7 align-self-center text-end">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb justify-content-end">
                            ...
                            <li class="breadcrumb-item"><a href="all_service_providers.php">All <?=$service_provider_title?></a></li>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <input type="text" id="USER_TITLE" name="USER_TITLE" class="form-control" placeholder="Enter Title" value="<?php echo $USER_TITLE?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
