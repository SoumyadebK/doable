                                                        ...
                                                        <div class="row pt-2" style="margin-bottom:10px;" >
                                                            ...
                                                            <div class="span9 col-md-10">
                                                                <select name="RECEPTION[]" id="RECEPTION" class="form-control required-entry select2" style="width:95%" multiple required>
                                                                    <?php $res_type = $res_type = $db_account->Execute("select PK_USER,USER_NAME,FIRST_NAME,LAST_NAME from DOA_USERS WHERE ACTIVE = '1' AND PK_ACCOUNT_MASTER = $PK_ACCOUNT_MASTER AND PK_USER != $_SESSION[PK_USER] OR PK_USER IN (".implode(',', $replay_user_array).")");
                                                                    while (!$res_type->EOF) {
