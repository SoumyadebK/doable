                                                    ...
                                                    <td>
                                                        <?php if ($standing == 0) { ?>
                                                            <?php if (in_array('Appointments Move/Copy', $PERMISSION_ARRAY)) { ?>
                                                                <a title="Copy" href="create_appointment.php?id=<?= $appointment_data->fields['PK_APPOINTMENT_MASTER'] ?>" style="font-size:18px"><i class="fa fa-copy"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <?php } ?>
                                                            <?php if (in_array('Calendar Delete', $PERMISSION_ARRAY) || in_array('Appointments Delete', $PERMISSION_ARRAY)) { ?>
                                                                <a title="Delete" href="javascript:" onclick="ConfirmDelete(<?= $appointment_data->fields['PK_APPOINTMENT_MASTER'] ?>, 'normal');" style="font-size:18px"><i class="fa fa-trash"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <?php } ?>
                                                        <?php } ?>
                                                    </td>
                                                    </tr>
