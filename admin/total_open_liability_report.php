                                    ...
                                    <table id="myTable" class="table table-bordered" data-page-length='50'>
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width:15%; text-align: center; font-weight: bold">Amount Ahead</th>
                                        ...
                                        <tbody>
                                            <?php
                                            $i = 1;
                                            $row = $db_account->Execute("SELECT DISTINCT PK_ENROLLMENT_MASTER FROM DOA_APPOINTMENT_MASTER WHERE PK_ENROLLMENT_MASTER != 0 AND DATE BETWEEN '" . date('Y-m-d', strtotime($from_date)) . "' AND '" . date('Y-m-d', strtotime($to_date)) . "' ORDER BY DATE DESC");
                                            while (!$row->EOF) {
