...
<div id="main-wrapper">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select required name="CUSTOMER_ID" id="CUSTOMER_ID" onchange="selectThisService(this);">
                                                        ...
                                                        while (!$row->EOF) {
                                                            ...
                                                            <option value="<?php echo '0,'.$row->fields['PK_SERVICE_CODE'].','.$row->fields['PK_SERVICE_MASTER'];?>"><?=$row->fields['SERVICE_NAME'].' || '.$row->fields['SERVICE_CODE'];?></option>
                                                        <?php $row->MoveNext(); } ?>
                                                    </select>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        ...
        /*function selectThisService(param) {
            ...
            selectThisServiceCode();
            getSlots();
        }*/

        /*function selectThisServiceCode() {
            let no_of_session = $('#PK_ENROLLMENT_MASTER').find(':selected').data('no_of_session');
            $('#NUMBER_OF_SESSION').val(no_of_session);
            let duration = $('#PK_ENROLLMENT_MASTER').find(':selected').data('duration');
            $('#DURATION').val(duration);
