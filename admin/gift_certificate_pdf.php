...
<html lang="">
<head>
    <link href="../assets/gift_certificate/style.css" rel="stylesheet">
    <link href="../assets/gift_certificate/bootstrap.min.css" rel="stylesheet">
...
<div class="main-content ">
    <div class="container">
        ...
        <div class="row" style="margin-bottom: 4rem;">
            <div class="col-lg-12">
                <h1 class="text-uppercase font-700 font-custom font44"><?php echo $GIFT_CERTIFICATE_NAME?></h1>
            </div>
        </div>
