...
<html lang="en">
<style>
    #enrollmentModelCalendar {
        z-index: 9;
    }

    #myModal {
        z-index: 10; // This will come above popup1
    }
</style>
<link href="../assets/sumoselect/sumoselect.min.css" rel="stylesheet"/>
<div id="enrollmentModelCalendar" class="modal">
    <!-- Modal content -->
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="PK_USER_MASTER" id="PK_USER_MASTER_ENROLLMENT" onchange="selectThisCustomerLocation(this);">
...
<script>
    ...
    $('#PK_USER_MASTER_ENROLLMENT').SumoSelect({placeholder: 'Select Customer', search: true, searchText: 'Search...'});
