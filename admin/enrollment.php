                                                ...
                                                <div class="col-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control PK_PACKAGE" name="PK_PACKAGE" id="PK_PACKAGE" onchange="selectThisPackage(this)">
                                                            ...
                                                            <?php
                                                            $row = $db_account->Execute("SELECT DOA_PACKAGE.PK_PACKAGE, DOA_PACKAGE.PACKAGE_NAME FROM DOA_PACKAGE WHERE PK_LOCATION IN (".$_SESSION['DEFAULT_LOCATION_ID'].") AND ACTIVE = 1 ORDER BY SORT_ORDER");
                                                            while (!$row->EOF) { ?>
