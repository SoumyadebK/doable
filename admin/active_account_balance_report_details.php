...
// $selected_date = date('Y-m-d', strtotime($_GET['selected_date']));
// $enrollment_date = "AND DOA_ENROLLMENT_MASTER.ENROLLMENT_DATE = '" . date('Y-m-d', strtotime($selected_date)) . "'";

// $selected_range = $_GET['selected_range'];
// $due_date = "AND DOA_APPOINTMENT_MASTER.DATE >= DATE_SUB(@$selected_date, INTERVAL $selected_range MONTH) AND DOA_APPOINTMENT_MASTER.DATE <= @$selected_date";
