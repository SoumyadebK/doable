                                        ...
                                        <table id="myTable" class="table table-bordered" data-page-length='50'>
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    $weekly_booked_data = $db_account->Execute("SELECT COUNT(DISTINCT(DOA_APPOINTMENT_MASTER.PK_APPOINTMENT_MASTER)) AS BOOKED_COUNT FROM DOA_APPOINTMENT_MASTER LEFT JOIN DOA_APPOINTMENT_SERVICE_PROVIDER ON DOA_APPOINTMENT_MASTER.PK_APPOINTMENT_MASTER = DOA_APPOINTMENT_SERVICE_PROVIDER.PK_APPOINTMENT_MASTER WHERE DOA_APPOINTMENT_SERVICE_PROVIDER.PK_USER IN (" . $PK_USER . ") AND DOA_APPOINTMENT_MASTER.PK_LOCATION IN (" . $_SESSION['DEFAULT_LOCATION_ID'] . ") AND PK_APPOINTMENT_STATUS != 6 AND (APPOINTMENT_TYPE = 'NORMAL' || APPOINTMENT_TYPE = 'AD-HOC') AND DOA_APPOINTMENT_MASTER.DATE BETWEEN $weekly_date_condition");
                                                    $weekly_showed_data = $db_account->Execute("SELECT COUNT(DISTINCT(DOA_APPOINTMENT_MASTER.PK_APPOINTMENT_MASTER)) AS SHOWED_COUNT FROM DOA_APPOINTMENT_MASTER LEFT JOIN DOA_APPOINTMENT_SERVICE_PROVIDER ON DOA_APPOINTMENT_MASTER.PK_APPOINTMENT_MASTER = DOA_APPOINTMENT_SERVICE_PROVIDER.PK_APPOINTMENT_MASTER WHERE DOA_APPOINTMENT_SERVICE_PROVIDER.PK_USER IN (" . $PK_USER . ") AND DOA_APPOINTMENT_MASTER.PK_LOCATION IN (" . $_SESSION['DEFAULT_LOCATION_ID'] . ") AND IS_CHARGED = 1 AND (APPOINTMENT_TYPE = 'NORMAL' || APPOINTMENT_TYPE = 'AD-HOC') AND DOA_APPOINTMENT_MASTER.DATE BETWEEN $weekly_date_condition");
                                                    ?>
                                                ...
                                                <tr>
                                                    ...
                                                    $yearly_booked_data = $db_account->Execute("SELECT COUNT(DISTINCT(DOA_APPOINTMENT_MASTER.PK_APPOINTMENT_MASTER)) AS BOOKED_COUNT FROM DOA_APPOINTMENT_MASTER LEFT JOIN DOA_APPOINTMENT_SERVICE_PROVIDER ON DOA_APPOINTMENT_MASTER.PK_APPOINTMENT_MASTER = DOA_APPOINTMENT_SERVICE_PROVIDER.PK_APPOINTMENT_MASTER WHERE DOA_APPOINTMENT_SERVICE_PROVIDER.PK_USER IN (" . $PK_USER . ") AND DOA_APPOINTMENT_MASTER.PK_LOCATION IN (" . $_SESSION['DEFAULT_LOCATION_ID'] . ") AND PK_APPOINTMENT_STATUS != 6 AND (APPOINTMENT_TYPE = 'NORMAL' || APPOINTMENT_TYPE = 'AD-HOC') AND DOA_APPOINTMENT_MASTER.DATE BETWEEN $net_year_date_condition");
                                                    $yearly_showed_data = $db_account->Execute("SELECT COUNT(DISTINCT(DOA_APPOINTMENT_MASTER.PK_APPOINTMENT_MASTER)) AS SHOWED_COUNT FROM DOA_APPOINTMENT_MASTER LEFT JOIN DOA_APPOINTMENT_SERVICE_PROVIDER ON DOA_APPOINTMENT_MASTER.PK_APPOINTMENT_MASTER = DOA_APPOINTMENT_SERVICE_PROVIDER.PK_APPOINTMENT_MASTER WHERE DOA_APPOINTMENT_SERVICE_PROVIDER.PK_USER IN (" . $PK_USER . ") AND DOA_APPOINTMENT_MASTER.PK_LOCATION IN (" . $_SESSION['DEFAULT_LOCATION_ID'] . ") AND IS_CHARGED = 1 AND (APPOINTMENT_TYPE = 'NORMAL' || APPOINTMENT_TYPE = 'AD-HOC') AND DOA_APPOINTMENT_MASTER.DATE BETWEEN $net_year_date_condition");
                                                    ?>
                                                ...
                                                <tr>
                                                    ...
                                                    $prev_year_booked_data = $db_account->Execute("SELECT COUNT(DISTINCT(DOA_APPOINTMENT_MASTER.PK_APPOINTMENT_MASTER)) AS BOOKED_COUNT FROM DOA_APPOINTMENT_MASTER LEFT JOIN DOA_APPOINTMENT_SERVICE_PROVIDER ON DOA_APPOINTMENT_MASTER.PK_APPOINTMENT_MASTER = DOA_APPOINTMENT_SERVICE_PROVIDER.PK_APPOINTMENT_MASTER WHERE DOA_APPOINTMENT_SERVICE_PROVIDER.PK_USER IN (" . $PK_USER . ") AND DOA_APPOINTMENT_MASTER.PK_LOCATION IN (" . $_SESSION['DEFAULT_LOCATION_ID'] . ") AND PK_APPOINTMENT_STATUS != 6 AND (APPOINTMENT_TYPE = 'NORMAL' || APPOINTMENT_TYPE = 'AD-HOC') AND DOA_APPOINTMENT_MASTER.DATE BETWEEN $prev_year_date_condition");
                                                    $prev_year_showed_data = $db_account->Execute("SELECT COUNT(DISTINCT(DOA_APPOINTMENT_MASTER.PK_APPOINTMENT_MASTER)) AS SHOWED_COUNT FROM DOA_APPOINTMENT_MASTER LEFT JOIN DOA_APPOINTMENT_SERVICE_PROVIDER ON DOA_APPOINTMENT_MASTER.PK_APPOINTMENT_MASTER = DOA_APPOINTMENT_SERVICE_PROVIDER.PK_APPOINTMENT_MASTER WHERE DOA_APPOINTMENT_SERVICE_PROVIDER.PK_USER IN (" . $PK_USER . ") AND DOA_APPOINTMENT_MASTER.PK_LOCATION IN (" . $_SESSION['DEFAULT_LOCATION_ID'] . ") AND IS_CHARGED = 1 AND (APPOINTMENT_TYPE = 'NORMAL' || APPOINTMENT_TYPE = 'AD-HOC') AND DOA_APPOINTMENT_MASTER.DATE BETWEEN $prev_year_date_condition");
                                                    ?>
