                                        ...
                                        while (!$row->EOF) {
                                            ...
                                            <tr data-id="<?= $row->fields['PK_ENROLLMENT_LEDGER'] ?>">
                                                ...
                                                <td style="text-align: center">
                                                    <button id="payNow" class="pay_now_button btn btn-info waves-effect waves-light m-l-10 text-white" onclick="payNow(<?= $row->fields['PK_ENROLLMENT_MASTER'] ?>, <?= $row->fields['PK_ENROLLMENT_LEDGER'] ?>, <?= $row->fields['BILLED_AMOUNT'] ?>, '<?= $row->fields['PK_ENROLLMENT_LEDGER'] ?>');">Pay Now</button>
