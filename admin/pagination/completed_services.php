<table id="myTable" class="table table-striped border" style="margin: auto; width: 50%;">
    ...
    <tbody>
        ...
        while (!$completed_service_data->EOF) {
            ...
            //if ($remain_session > 0) {
            if (isset($pending_service_code_array[$completed_service_data->fields['SERVICE_CODE']])) {
                $pending_service_code_array[$completed_service_data->fields['SERVICE_CODE']]['CODE'] = $completed_service_data->fields['SERVICE_CODE'];
                $pending_service_code_array[$completed_service_data->fields['SERVICE_CODE']]['ENROLL'] += $NUMBER_OF_SESSION;
                $pending_service_code_array[$completed_service_data->fields['SERVICE_CODE']]['REMAIN'] += $remain_session;
                $pending_service_code_array[$completed_service_data->fields['SERVICE_CODE']]['PAID'] += $completed_service_data->fields['TOTAL_AMOUNT_PAID'];
                $pending_service_code_array[$completed_service_data->fields['SERVICE_CODE']]['USED'] += $SESSION_COMPLETED;
                $pending_service_code_array[$completed_service_data->fields['SERVICE_CODE']]['SCHEDULED'] += $SESSION_SCHEDULED;
                $pending_service_code_array[$completed_service_data->fields['SERVICE_CODE']]['BALANCE'] += $ps_balance;
            } else {
                $pending_service_code_array[$completed_service_data->fields['SERVICE_CODE']]['CODE'] = $completed_service_data->fields['SERVICE_CODE'];
                $pending_service_code_array[$completed_service_data->fields['SERVICE_CODE']]['ENROLL'] = $NUMBER_OF_SESSION;
                $pending_service_code_array[$completed_service_data->fields['SERVICE_CODE']]['REMAIN'] = $remain_session;
