...
if ($_GET['type'] == 'normal') { ?>
    <div class="row" style="padding: 35px 35px 0 35px">
        ...
        <div class="col-md-3">
            ...
            ?>
            <!--<a class="btn btn-info d-none d-lg-block m-15 text-white right" href="enrollment.php?id_customer=<?php /*=$_GET['pk_user']*/?>&master_id_customer=<?php /*=$PK_USER_MASTER*/?>&source=customer" style="width: 120px; "><i class="fa fa-file-export"></i> Export</a>-->
        ...
        <table id="myTable" class="table" style="display: none">
            ...
            while (!$billing_details->EOF) {
                ...
                <tr style="border-style: hidden; background-color: <?=(fmod($b, 2) == 0) ? '#ebeced' : ''?>;">
                    ...
                    <td style="text-align: right;"><?=($billing_details->fields['AMOUNT_REMAIN'] > 0) ? $billing_details->fields['AMOUNT_REMAIN'] : ''?><?php /*=number_format((float)$balance, 2, '.', '')*/?></td>
