...
$booked_slot_data = $db->Execute("SELECT START_TIME, END_TIME FROM DOA_APPOINTMENT_MASTER WHERE PK_SERVICE_MASTER = ".$PK_SERVICE_MASTER." AND PK_SERVICE_CODE = ".$PK_SERVICE_CODE." AND SERVICE_PROVIDER_ID = ".$SERVICE_PROVIDER_ID." AND DATE = "."'".$date."'");
$booked_slot_array = [];
$j = 0;
