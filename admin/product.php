                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label class="col-md-12" for="example-text">Product ID/ SKU (Stock Keeping Unit) :</label>
                                            <div class="col-md-12">
                                                <input type="text" id="PRODUCT_ID" name="PRODUCT_ID" class="form-control" placeholder="Enter Product ID/SKU" value="<?php echo $PRODUCT_ID?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
