...
if (!empty($_GET['NAME'])) {
    ...
    if ($generate_pdf === 1) {
        header('location:generate_report_pdf.php?PK_PACKAGE=' . $PK_PACKAGE . '&TRANSPORTATION_CHARGES=' . $TRANSPORTATION_CHARGES . '&PACKAGE_COSTS=' . $PACKAGE_COSTS . '&type=' . $type);
    } elseif ($generate_excel === 1) {
        header('location:excel_miscellaneous_service_summary_report.php?PK_PACKAGE=' . $PK_PACKAGE . '&TRANSPORTATION_CHARGES=' . $TRANSPORTATION_CHARGES . '&PACKAGE_COSTS=' . $PACKAGE_COSTS . '&type=' . $type);
    } else {
                                    ...
                                    <div class="table-responsive">
                                        <table id="myTable" class="table table-bordered" data-page-length='50'>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center">$<?= number_format($row->fields['TOTAL_AMOUNT'], 2) ?></td>
                                            ...
                                            <tr>
                                                ...
                                                <th style="width:10%; text-align: center">$<?= number_format($total_charges_due, 2) ?></th>
                                                <th style="width:10%; text-align: center">$<?= number_format($total_payment_amount, 2) ?></th>
                                                <th style="width:10%; text-align: center"></th>
                                                <th style="width:10%; text-align: center"></th>
                                            </tr>
                                        </table>
                                        <table id="myTable" class="table table-bordered" data-page-length='50'>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <tr>
                                                    <td style="text-align: center">$<?= number_format($total_charges_due, 2) ?></td>
