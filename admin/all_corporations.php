                                        ...
                                        <table id="myTable" class="table table-striped border" data-page-length='50'>
                                            ...
                                            while (!$row->EOF) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="corporation.php?id=<?=$row->fields['PK_CORPORATION']?>"><img src="../assets/images/edit.png" title="Edit" style="padding-top:5px"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="all_corporations.php?type=del&id=<?=$row->fields['PK_CORPORATION']?>" onclick='javascript:ConfirmDelete(<?=$row->fields['PK_LOCATION']?>);return false;'><img src="../assets/images/delete.png" title="Delete" style="padding-top:3px"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            function ConfirmDelete(PK_CORPORATION)
            {
                ...
                if(conf) {
                    $.ajax({
                        ...
                        type: 'POST',
                        data: {FUNCTION_NAME: 'deleteCorporationData', PK_CORPORATION: PK_CORPORATION},
