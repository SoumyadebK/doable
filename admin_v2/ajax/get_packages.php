...
while (!$package_service_data->EOF) {
    $unique_id = "package_service_" . $service_counter . "_" . $package_service_data->fields['PK_SERVICE_MASTER'];
?>
    ...
    <div class="collapse" id="<?= $unique_id ?>">
        ...
        <div class="d-inline-flex gap-1">
            ...
            <div class="session-item">
                ...
                <div class="session-item position-relative">
                    <input type="text" class="form-control form-control-sm" value="<?= $package_service_data->fields['DISCOUNT'] ?>" style="padding-left: 20px;">
                    <span class="position-absolute" style="top: 7px; left: 10px;">$</span>
                </div>
            </div>
            <div class="session-item" style="min-width: 45px;">
