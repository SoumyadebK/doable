...
if (empty($_POST['slot_time'])) {
    ...
    if (count($available_slots) > 0) {
        ...
        <span data-is_disable="1" class="slot_btn" style="width: 200%;">No slot available on your selected date</span>
        <?php }
} else {
    ...
    if (count($time_slot_array) > 0) {
        ...
        <span data-is_disable="1" class="slot_btn">No slot available on your selected date</span>
<?php }
} ?>