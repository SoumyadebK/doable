...
$followup_data = $db_account->Execute("SELECT * FROM DOA_AUTOMATION_LOG WHERE IS_ARCHIVE = 0 AND FIND_IN_SET('$SERVICE_PROVIDER_ID', LAST_CLASS_SP_ID) > 0 ORDER BY CREATED_ON DESC");
