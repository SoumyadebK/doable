...
if ($APPOINTMENT_TYPE == 'group_class') {
    ...
    $PK_SERVICE_PROVIDER = $_POST['SERVICE_PROVIDER_ID'];
    ...
    if (isset($_POST['PK_APPOINTMENT_STATUS_NEW']) && ($_POST['PK_APPOINTMENT_STATUS_OLD'] != $_POST['PK_APPOINTMENT_STATUS_NEW'])) {
        ...
        $APPOINTMENT_STATUS_HISTORY_DATA['PK_APPOINTMENT_STATUS'] = $_POST['PK_APPOINTMENT_STATUS_NEW'];
...
} elseif ($APPOINTMENT_TYPE == 'special_appointment') {
    ...
    if (isset($_POST['PK_APPOINTMENT_STATUS_NEW'])) {
