...
<div class="customer-profile d-flex p-3">
    <input type="hidden" class="PK_USER_MASTER" value="<?= $PK_USER_MASTER ?>">
    ...
    <div class="tab-pane fade show active" id="Details" role="tabpanel">
        <div class="booking-lesson p-3 border-bottom">
            ...
            <h6 class="f14">
                ...
                <span class="badge bg-secondary rounded-pill"><?= $enrollment_data->RecordCount() ?></span>
            </h6>
            <?php
            ...
            ?>
                <div class="form-check border rounded-2 p-2 mb-2">
                    <div class="d-flex">
                        ...
                        <label class="form-check-label"><?= ($enrollment_data->fields['ENROLLMENT_ID'] == null) ? $enrollment_name . $enrollment_data->fields['MISC_ID'] : $enrollment_name . $enrollment_data->fields['ENROLLMENT_ID'] ?></label>
                        <?php
