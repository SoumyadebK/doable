        ...
        <div class="booking-lesson p-3">
            <div class="form-check border rounded-2 p-2 mb-2">
                <div class="d-flex">
                    ...
                    <span class="badge border ms-auto" style="background-color: #ffeaf4; color: #f573b6;">GRP</span>
            ...
            <div class="form-check border rounded-2 p-2 mb-2">
                <div class="d-flex">
                    ...
                    <label class="form-check-label">Salsa Beginner</label>
                    <span class="badge border ms-auto" style="background-color: #eeebff; color: #8c75e7;">EXT</span>
                    <span class="badge bg-light fw-normal theme-text-light ms-1">1 of 4</span>
                </div>
                <div class="statusareatext f12 theme-text-light" style="margin-left: 27px;">
                    <span class="text-uppercase">Fridat Dec 19, 8:00 - 9:00 AM (PST)</span>
                    <ul class="list-inline mb-0 mt-1">
                        <li class="list-inline-item fw-semibold">
                            <span class="namebadge badge badgeprimary badge-pill px-1">CB</span>
                            <span class="name">Chandler Bing</span>
