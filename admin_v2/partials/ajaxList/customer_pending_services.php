    ...
    <div class="accordion-item">
        <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                <b>Summary of Pending Services</b>
            </button>
        </h2>
            ...
            <div class="accordion-body">
                <div class="table-responsive mb-1">
                    <table class="table border-0 mb-0">
                        ...
                        <tbody>
                            <?php
                            $pending_service_data = $db_account->Execute("SELECT DOA_ENROLLMENT_SERVICE.*, DOA_SERVICE_CODE.SERVICE_CODE, DOA_ENROLLMENT_MASTER.CHARGE_TYPE FROM DOA_ENROLLMENT_SERVICE LEFT JOIN DOA_ENROLLMENT_MASTER ON DOA_ENROLLMENT_SERVICE.PK_ENROLLMENT_MASTER = DOA_ENROLLMENT_MASTER.PK_ENROLLMENT_MASTER JOIN DOA_SERVICE_CODE ON DOA_ENROLLMENT_SERVICE.PK_SERVICE_CODE = DOA_SERVICE_CODE.PK_SERVICE_CODE WHERE (DOA_ENROLLMENT_MASTER.STATUS = 'CA' || DOA_ENROLLMENT_MASTER.STATUS = 'A') AND DOA_ENROLLMENT_MASTER.PK_USER_MASTER = " . $PK_USER_MASTER);
                            ...
                            while (!$pending_service_data->EOF) {
                                if ($pending_service_data->fields['CHARGE_TYPE'] == 'Membership') {
                                    ...
                                    $NUMBER_OF_SESSION = ($pending_service_data->fields['NUMBER_OF_SESSION'] > 0) ? $pending_service_data->fields['NUMBER_OF_SESSION'] : 0;
                                }
                                ...
                                $TOTAL_AMOUNT_PAID = ($pending_service_data->fields['TOTAL_AMOUNT_PAID'] > 0) ? $pending_service_data->fields['TOTAL_AMOUNT_PAID'] : 0;
                                ...
                                if (isset($pending_service_code_array[$pending_service_data->fields['SERVICE_CODE']])) {
                                    ...
                                    $pending_service_code_array[$pending_service_data->fields['SERVICE_CODE']]['PAID'] += $TOTAL_AMOUNT_PAID;
                            ...
                            <?php foreach ($pending_service_code_array as $service_code) { ?>
                                <tr>
                                    <td style="text-align: center;"><span class="badge-service" style="background-color: <?= getServiceCodeColor($service_code['CODE']) ?>20; color: <?= getServiceCodeColor($service_code['CODE']) ?>;"><?= $service_code['CODE'] ?></span> </td>
