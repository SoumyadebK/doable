...
$ORPHAN_APPOINTMENT_QUERY = "SELECT
                        ...
                        AND (DOA_APPOINTMENT_MASTER.APPOINTMENT_TYPE = 'AD-HOC' OR (DOA_APPOINTMENT_MASTER.APPOINTMENT_TYPE = 'GROUP' AND DOA_APPOINTMENT_ENROLLMENT.PK_ENROLLMENT_MASTER = 0 AND DOA_APPOINTMENT_ENROLLMENT.PK_ENROLLMENT_SERVICE = 0))
            ...
            <table id="myTable" class="table border-0" data-page-length='50'>
                <thead style="cursor:pointer;" onclick="$(this).next().slideToggle();">
                    <tr>
                        ...
                        <th data-type="string" style="cursor: pointer; text-align: center;">Service Code</th>
                        <th data-type="string" style="cursor: pointer; text-align: center;"><?= $service_provider_title ?></th>
                        <th data-type="string" style="cursor: pointer; text-align: center;">Day</th>
                        <th data-date data-order style="cursor: pointer; text-align: center;">Date</th>
                        <th data-type="string" style="cursor: pointer; text-align: center;">Time</th>
                        <th data-type="string" style="cursor: pointer; text-align: center;">Status</th>
                    </tr>
                </thead>
                ...
                <tbody style="display: none">
                    ...
                    while (!$orphan_appointment_data->EOF) {
                        ...
                        <tr>
                            <td style="text-align: center;" id="<?= $orphan_appointment_data->fields['PK_APPOINTMENT_MASTER'] ?>"><?= $i; ?></td>
                            <td style="text-align: center;"><?= $orphan_appointment_data->fields['SERVICE_NAME'] ?></td>
                            <td style="text-align: center;">
                                <span class="badge-service" style="background-color: <?= getServiceCodeColor($orphan_appointment_data->fields['SERVICE_CODE']) ?>20; color: <?= getServiceCodeColor($orphan_appointment_data->fields['SERVICE_CODE']) ?>;">
                                    <?= $orphan_appointment_data->fields['SERVICE_CODE'] ?>
                                </span>
                            </td>
                            <td style="text-align: center;">
                                <span class="avatarname" style="color: #fff; background-color: <?= $profile_color ?>;">
                                    <?= $profile_initial ?>
                                </span>
                                <?= $orphan_appointment_data->fields['SERVICE_PROVIDER_NAME'] ?>
                            </td>
                            <td style="text-align: center;"><?= date('l', strtotime($orphan_appointment_data->fields['DATE'])) ?></td>
                            <td style="text-align: center;"><?= date('m/d/Y', strtotime($orphan_appointment_data->fields['DATE'])) ?></td>
                            <td style="text-align: center;"><?= date('h:i A', strtotime($orphan_appointment_data->fields['START_TIME'])) . " - " . date('h:i A', strtotime($orphan_appointment_data->fields['END_TIME'])) ?></td>
                            <td style="text-align: center;">
                                <span class="badge-service" style="background-color: <?= $orphan_appointment_data->fields['APPOINTMENT_COLOR'] ?>20 !important; color: <?= $orphan_appointment_data->fields['APPOINTMENT_COLOR'] ?> !important;">
                                    <?= $orphan_appointment_data->fields['APPOINTMENT_STATUS'] ?>
                                </span>
                            </td>
                        </tr>
