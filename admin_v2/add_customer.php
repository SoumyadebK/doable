...
$country_data = $db->Execute("SELECT * FROM DOA_COUNTRY ORDER BY COUNTRY_NAME");
$country_options = '';
while (!$country_data->EOF) {
    $country_options .= '<option value="' . $country_data->fields['PK_COUNTRY'] . '">' . $country_data->fields['COUNTRY_NAME'] . '</option>';
    $country_data->MoveNext();
}

$tag_data = $db_account->Execute("SELECT * FROM DOA_TAG WHERE ACTIVE = 1");
$tag_options = '';
while (!$tag_data->EOF) {
...
$relationship_data = $db->Execute("SELECT * FROM DOA_RELATIONSHIP WHERE ACTIVE = 1");
$relationship_options = '';
while (!$relationship_data->EOF) {
    $relationship_options .= '<option value="' . $relationship_data->fields['PK_RELATIONSHIP'] . '">' . $relationship_data->fields['RELATIONSHIP'] . '</option>';
    $relationship_data->MoveNext();
}

$title = $IS_CREATE_MODE ? "Add New Customer" : ($FIRST_NAME . " " . $LAST_NAME);
?>
<!DOCTYPE html>
<html lang="en">
...
<style>
    ...
    .family-member-row .remove-family-btn {
        position: absolute;
        top: 10px;
        right: 15px;
        color: #dc3545;
    ...
    .family-member-row .remove-family-btn:hover {
        color: #a71d2a;
    }
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-0 pb-2 border-bottom px-3">
                        <div class="d-flex align-items-center">
                            <?php if ($IS_CREATE_MODE) { ?>
                                <div class="bg-warning-subtle text-warning-emphasis d-flex align-items-center justify-content-center rounded-circle me-3" style="width: 50px; height: 50px; font-weight: bold; color: #fff !important; background-color: #6c757d !important;">+</div>
                        ...
                        <?php } else { ?>
                            <a href="all_customers.php" class="btn btn-outline-secondary rounded-pill px-4">Cancel</a>
                        <?php } ?>
                    </div>
                        ...
                        <div class="col-md-10 right-panel">
                            <?php if ($IS_CREATE_MODE) { ?>
                                ...
                                <div class="tab-content tab-content-1 active row profile-section">
                                        ...
                                        <div class="col-md-12 pt-4">
                                            ...
                                            <div class="profile-card">
                                                <div class="d-flex justify-content-between border-bottom align-items-center">
                                                    <div>
                                                        ...
                                                        <div class="section-desc">Enter the customer's basic information</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Primary Location <span class="required-star">*</span></label>
                                                            <select class="form-control" name="PK_LOCATION" required>
                                            ...
                                            <div class="profile-card">
                                                <div class="border-bottom pb-3">
                                                    <div class="row">
                                                        <div class="col-md-6 section-title">Will you be attending your lessons</div>
                                                        <div class="col-md-3 section-title">
                                                            <label><input type="radio" name="ATTENDING_WITH" class="form-check-inline" value="Solo" checked onclick="handleAttendingWithChange(this)"> Solo</label>
                                                        </div>
                                                        <div class="col-md-3 section-title">
                                                            <label><input type="radio" name="ATTENDING_WITH" class="form-check-inline" value="With a Partner" onclick="handleAttendingWithChange(this)"> With a Partner</label>
                                                        </div>
                                                    </div>
                                                </div>

                                                <div class="row mt-3" id="partner_details" style="display: none;">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Partner's First Name</label>
                                                            <input type="text" class="form-control" name="PARTNER_FIRST_NAME" placeholder="Enter Partner's First Name">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Partner's Last Name</label>
                                                            <input type="text" class="form-control" name="PARTNER_LAST_NAME" placeholder="Enter Partner's Last Name">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Partner's Phone</label>
                                                            <input type="text" class="form-control format_phone_number" name="PARTNER_PHONE" placeholder="(xxx) xxx-xxxx">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Partner's Email</label>
                                                            <input type="email" class="form-control" name="PARTNER_EMAIL" placeholder="Enter Partner's Email">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                            ...
                                            <div class="profile-card">
                                                <div class="d-flex justify-content-between border-bottom align-items-center">
                                                    <div>
                                                        ...
                                                        <div class="section-desc">Add additional phone numbers and email addresses</div>
                                                    </div>
                                                </div>

                                                <div class="row mt-3">
                                                    <div class="col-md-12">
                                                        <div id="additional_phones_container">
                                                            <div class="row mb-2">
                                                                <div class="col-md-10">
                                                    ...
                                                    <div class="col-md-12 mt-3">
                                                        <div id="additional_emails_container">
                                                            <div class="row mb-2">
                                                                <div class="col-md-10">
                                            ...
                                            <div class="profile-card">
                                                <div class="d-flex justify-content-between border-bottom align-items-center">
                                                    <div>
                                                        ...
                                                        <div class="section-desc">Add special dates like anniversaries, birthdays, etc.</div>
                                                    </div>
                                                </div>

                                                <div class="mt-3">
                                                    <div id="special_dates_container">
                                                        <div class="row mb-2 align-items-end">
                                                            <div class="col-md-4">
                                                                <input type="text" class="form-control" name="SPECIAL_DATE_NAMES[]" placeholder="Date Title">
                                                            </div>
                                                            <div class="col-md-4">
                                    ...
                                    <?php } else { ?>
                                        <!-- VIEW/EDIT MODE: Existing display -->
                                                ...
                                                <div class="profile-card">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <div class="value"><?= date('m / d / Y', strtotime($CREATED_ON)) ?></div>
                                                        </div>
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <div class="value">
                                                                ...
                                                                if (!empty($selected_location)) {
                                                                    $location_data2 = $db->Execute("SELECT * FROM DOA_LOCATION WHERE PK_LOCATION IN (" . implode(",", $selected_location) . ")");
                                                                    $location_name_arr = [];
                                                                    while (!$location_data2->EOF) {
                                                                        $location_name_arr[] = $location_data2->fields['LOCATION_NAME'];
                                                                        $location_data2->MoveNext();
                                                                    }
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <div class="value">
                                                                ...
                                                                if (!empty($selected_tag)) {
                                                                    $tag_data2 = $db_account->Execute("SELECT * FROM DOA_TAG WHERE PK_TAG IN (" . implode(",", $selected_tag) . ")");
                                                                    $tag_name_arr = [];
                                                                    while (!$tag_data2->EOF) {
                                                                        $tag_name_arr[] = $tag_data2->fields['TAG_NAME'];
                                                                        $tag_data2->MoveNext();
                                                                    }
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <div class="value"><?= ($DOB == '' || $DOB == '0000-00-00' || $DOB == '1969-12-31') ? '' : date('m / d / Y', strtotime($DOB)) ?></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-content tab-content-2 row family-section">
                                    <?php if ($IS_CREATE_MODE) { ?>
                                        <!-- CREATE MODE: Family form -->
                                        <div class="col-md-12 pt-4">
                                            <div class="main-card mr-auto">
                                                <div class="section-title">Family Information</div>
                                                <div class="section-desc border-bottom pb-3">Add family members who will be associated with this customer</div>

                                                <div class="mt-4" id="family_members_container">
                                                    <div class="no-family-members" id="no_family_members">
                                ...
                                <?php if (!$IS_CREATE_MODE) { ?>
                                    ...
                                    <div class="tab-content tab-content-3 row enrollments-section">
                                        <div class="col-md-12 px-4 pt-4 pb-4" id="enrollment_list"></div>
                                    </div>

                                    <!-- Tab 4: Appointments -->
                                    <div class="tab-content tab-content-4 row appointment-section">
                                        <div class="col-md-12 px-4 pt-4 pb-4" id="appointment_area"></div>
                                    </div>

                                    <!-- Tab 5: Payments -->
                                    <div class="tab-content tab-content-5 row payments-section">
                                        <div class="col-md-12 px-3 pt-4 pb-4" id="payment_list"></div>
                                    </div>
                                        ...
                                        <div class="col-md-12 px-3 pt-4 pb-4">
                                            <div class="payments-card">
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <div class="row mt-4" id="saved_credit_card_list" style="display: none;"></div>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
...
<!-- Family Member Template (hidden) for CREATE mode -->
<div id="family_member_template" style="display: none;">
    <div class="family-member-row">
        <button type="button" class="remove-family-btn" onclick="removeFamilyMember(this)"><i class="bi bi-x-circle"></i></button>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="form-label">First Name <span class="required-star">*</span></label>
                    <input type="text" class="form-control" name="FAMILY_MEMBERS[__INDEX__][FIRST_NAME]" placeholder="Enter First Name" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label class="form-label">Last Name <span class="required-star">*</span></label>
                    <input type="text" class="form-control" name="FAMILY_MEMBERS[__INDEX__][LAST_NAME]" placeholder="Enter Last Name" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label class="form-label">Relationship <span class="required-star">*</span></label>
                    <select class="form-control" name="FAMILY_MEMBERS[__INDEX__][PK_RELATIONSHIP]" required>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" name="FAMILY_MEMBERS[__INDEX__][EMAIL]" placeholder="Enter Email">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label class="form-label">Phone</label>
                    <input type="text" class="form-control format_phone_number" name="FAMILY_MEMBERS[__INDEX__][PHONE]" placeholder="(xxx) xxx-xxxx">
                </div>
            </div>
        </div>
    </div>
...
<!-- All existing modals (keep all your modals from the original) -->
                ...
                <div class="tab-pane" id="credit_card" role="tabpanel">
                    <div class="p-20">
                        ...
                        <?php } else { ?>
                            <div class="row">
                                <div class="col-md-12">
                                    <div id="add_credit_card_div_auto_pay" style="display: none; width: 150%;"></div>
                                </div>
                            </div>
                            <div class="row" id="saved_credit_card_list_auto_pay" style="display: none; padding-left: 6%;"></div>
                        <?php } ?>
                    </div>
                </div>
...
<div class="modal fade" id="edit_appointment_modal" tabindex="-1" aria-hidden="true"></div>
...
<script>
    ...
    // ============================================
    // CREATE MODE Specific Functions
    // ============================================
    ...
    function handleAttendingWithChange(element) {
        ...
        if (value === 'With a Partner' && isChecked) {
            $('#partner_details').slideDown();
        } else if (value === 'Solo' && isChecked) {
    ...
    function addPhoneField() {
        ...
        `;
        $('#additional_phones_container').append(html);
    }
    ...
    function addSpecialDateField() {
        ...
        `;
        $('#special_dates_container').append(html);
    ...
    function addFamilyMemberField() {
        var template = $('#family_member_template').html();
        var html = template.replace(/__INDEX__/g, familyMemberIndex);
    ...
    function removeFamilyMember(btn) {
        ...
        if ($('#family_members_container .family-member-row').length === 0) {
            $('#no_family_members').show();
        }
    }

    // Country -> State Dynamic Loading
    $(document).on('change', '#PK_COUNTRY', function() {
        var countryId = $(this).val();
        var stateSelect = $('#PK_STATES');
        ...
        if (countryId) {
            $.ajax({
                ...
                type: 'POST',
                data: {
                    FUNCTION_NAME: 'getStatesByCountry',
                    PK_COUNTRY: countryId
                },
                dataType: 'json',
                success: function(data) {
                    ...
                    if (data.length > 0) {
                        $.each(data, function(index, state) {
                            stateSelect.append('<option value="' + state.PK_STATES + '">' +
    ...
    // ============================================
    // All existing functions from original customer.php
