...
if (!empty($_POST)) {
    ...
    // Handle trigger value for services
...
if (!empty($_GET['id'])) {
    ...
    // Decode trigger value for services
    ...
    <script>
        ...
        function loadTriggerValueField() {
            ...
            if (selectedType === 'no_specific_services') {
                ...
                fetch(url, {
                        credentials: 'same-origin', // Important: send cookies/session
                        headers: {
