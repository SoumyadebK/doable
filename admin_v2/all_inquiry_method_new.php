                ...
                <div class="main-card">
                    ...
                    <div class="d-flex justify-content-between align-items-start mb-4 flex-wrap gap-3">
                        <div>
                            <h2 class="fw-semibold h4 mb-1">
                                <?php if ($status_check == 'inactive') { ?>
                                    <i class="bi bi-archive me-2 text-muted"></i>Not Active Inquiry Methods
                                <?php } else { ?>
                                    <i class="bi bi-chat-dots me-2 text-primary"></i>Active Inquiry Methods
                                <?php } ?>
                            </h2>
                        ...
                        <div class="d-flex gap-2">
                            <?php if ($status_check == 'inactive') { ?>
                                <button class="btn btn-outline-custom d-flex align-items-center gap-2" onclick="window.location.href='all_inquiry_methods.php?status=active'">
                                    <i class="bi bi-check-circle"></i> Show Active
                                </button>
                            <?php } else { ?>
                                <button class="btn btn-outline-custom d-flex align-items-center gap-2" onclick="window.location.href='all_inquiry_methods.php?status=inactive'">
                                    <i class="bi bi-archive"></i> Show Not Active
                                </button>
                            <?php } ?>
