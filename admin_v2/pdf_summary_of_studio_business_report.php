                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table id="collapseTable" style="width:100%">
                            <thead>
                                <tr>
                                    <th style="width:40%; text-align: center; vertical-align:auto; font-weight: bold"><?= ($res->fields['FRANCHISE'] == 1) ? 'Franchisee: ' : '' ?><?= $concatenatedResults ?></th>
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="collapseTable" style="width:100%">
                            <thead>
                                ...
                                <?php
                                $yearly_pre_original_tried = $db_account->Execute("SELECT COUNT(DOA_ENROLLMENT_MASTER.PK_ENROLLMENT_MASTER) AS TRIED FROM `DOA_ENROLLMENT_MASTER` LEFT JOIN DOA_ENROLLMENT_BILLING ON DOA_ENROLLMENT_MASTER.PK_ENROLLMENT_MASTER = DOA_ENROLLMENT_BILLING.PK_ENROLLMENT_MASTER WHERE DOA_ENROLLMENT_MASTER.PK_LOCATION IN (" . $_SESSION['DEFAULT_LOCATION_ID'] . ") AND DOA_ENROLLMENT_BILLING.TOTAL_AMOUNT > 0 AND PK_ENROLLMENT_TYPE = 5 AND ENROLLMENT_ID NOT LIKE '%MISC%' AND ENROLLMENT_DATE BETWEEN $net_year_date_condition");
                        ...
                        <table id="collapseTable" style="width:100%">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th style="width:10%; text-align: center; font-weight: normal !important">$<?= number_format($weekly_class_sales->fields['SALES'], 2) ?></th>
                                ...
                                <tr>
                                    ...
                                    <th style="width:10%; text-align: center; font-weight: normal !important">$<?= number_format($yearly_class_sales->fields['SALES'], 2) ?></th>
                                    <th style="width:10%; text-align: center; font-weight: normal !important">$0.00</th>
                                ...
                                <tr>
                                    ...
                                    <th style="width:10%; text-align: center; font-weight: normal !important">$<?= number_format($prev_year_class_sales->fields['SALES'], 2) ?></th>
                                    <th style="width:10%; text-align: center; font-weight: normal !important">$0.00</th>
