                                ...
                                <div class="card-modern">
                                    <div class="card-header">
                                        <h5>
                                            ...
                                            <?= !empty($_GET['id']) ? 'Edit Inquiry Method' : 'Add Inquiry Method' ?>
                                        </h5>
                                        ...
                                        <form class="form-material form-horizontal" action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-grid">
                                                ...
                                                <div class="form-group-modern">
                                                    <label class="form-label">Inquiry Method <span class="required">*</span></label>
                                                    <input type="text" id="INQUIRY_METHOD" name="INQUIRY_METHOD" class="form-control-modern" placeholder="Enter Inquiry Method" required value="<?php echo htmlspecialchars($INQUIRY_METHOD) ?>">
                                                    <div class="form-helper">Enter the name of the inquiry method</div>
                                                </div>
                                                ...
                                                <?php if (!empty($_GET['id'])): ?>
                                                    <div class="form-group-modern">
                                                        ...
                                                        <div class="form-helper">Set the status of this inquiry method</div>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <button type="button" class="btn-modern btn-modern-secondary" onclick="window.location.href='all_inquiry_methods.php'">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (form) {
            const inquiryMethod = document.getElementById('INQUIRY_METHOD');

            form.addEventListener('submit', function(e) {
                let isValid = true;

                if (!inquiryMethod.value.trim()) {
                    inquiryMethod.classList.add('is-invalid');
                    isValid = false;
                } else {
                    inquiryMethod.classList.remove('is-invalid');
                }
            ...
            inquiryMethod.addEventListener('input', function() {
                if (this.value.trim()) {
