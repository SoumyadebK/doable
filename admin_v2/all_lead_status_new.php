...
$header_text = '';
$header_data = $db->Execute("SELECT * FROM `DOA_HEADER_TEXT` WHERE ACTIVE = 1 AND HEADER_TITLE = 'Order Status page'");
            ...
            <div class="col-12 col-md-8 col-xl-9">
                <div class="main-card">
                        ...
                        <div>
                            <h2 class="fw-semibold h4 mb-1">
                                <?php if ($status_check == 'inactive') { ?>
                                    <i class="bi bi-archive me-2 text-muted"></i>Not Active Order Status
                                <?php } else { ?>
                                    <i class="bi bi-check2-square me-2 text-primary"></i>Active Order Status
                                <?php } ?>
                            </h2>
                            <p class="text-muted small mb-0">Manage order/lead statuses, colors, and display order</p>
                        </div>
                    ...
                    <div class="text-muted small mb-3 d-flex align-items-center gap-2">
                        <i class="bi bi-tags"></i> <?= $total_records ?> <?= $total_records == 1 ? 'order status' : 'order statuses' ?>
                    </div>
                                ...
                                if ($total_records == 0):
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-center py-5">
                                            ...
                                            <p class="mt-3 text-muted">No order statuses found for the selected filters</p>
                                            <button class="btn btn-sm btn-outline-primary mt-2" onclick="createNewStatus()">Create your first order status</button>
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
