                                        ...
                                        <tbody>
                                            ...
                                            while (!$row->EOF) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="document_library.php?id=<?= $row->fields['PK_DOCUMENT_LIBRARY'] ?>" title="Edit" style="font-size:18px"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="all_document_library.php?type=del&id=<?= $row->fields['PK_DOCUMENT_LIBRARY'] ?>" onclick="javascript:ConfirmDelete(<?= $row->fields['PK_DOCUMENT_LIBRARY'] ?>);" title="Delete" style="font-size:18px"><i class="fa fa-trash"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
