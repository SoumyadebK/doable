                                    ...
                                    <tr style="height: 60px;">
                                        ...
                                        <td>
                                            <?php if ($customer_data->fields['ACTIVE'] == 1) {
                                                if (($customer_data->fields['CREATED_ON'] < date('Y-m-d H:i:s', strtotime("-" . $USER_INACTIVE_DAYS . " days"))) && ($DAYS_SINCE_LAST_APPOINTMENT >= $USER_INACTIVE_DAYS)) { ?>
