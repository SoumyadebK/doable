...
if (!empty($_POST)) {
    ...
    $BUSINESS_TYPE_DATA['AMI_ENABLE'] = !empty($_POST['AMI_ENABLE']) ? 1 : 0;
    if (empty($_GET['id'])) {
...
if (empty($_GET['id'])) {
    ...
    $AMI_ENABLE = $res->fields['AMI_ENABLE'];
                            ...
                            <div class="card-body">
                                <form class="form-material form-horizontal" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-8 form-group">
                                            <label>
                                                <input type="checkbox" style="vertical-align: middle; margin-top: -2px;"
                                                    id="AMI_ENABLE" name="AMI_ENABLE" value="1"
                                                    <?php if ($AMI_ENABLE == 1) echo 'checked="checked"'; ?>>
                                                Arthur Murray Enabled
                                            </label>
                                        </div>
                                    </div>
