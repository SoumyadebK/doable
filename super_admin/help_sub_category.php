...
if(!empty($_POST)){
	...
	if($_GET['id'] == ''){
		$HELP_SUB_CATEGORY['CREATED_BY']  = $_SESSION['PK_USER'];
		$HELP_SUB_CATEGORY['CREATED_ON']  = date("Y-m-d H:i");

		if(empty($_POST['DISPLAY_ORDER'])) unset($HELP_SUB_CATEGORY['DISPLAY_ORDER']);

		db_perform('DOA_M_HELP_SUB_CATEGORY', $HELP_SUB_CATEGORY, 'insert');
		$PK_HELP_SUB_CATEGORY = $db->insert_ID();
	} else {
		$HELP_SUB_CATEGORY['EDITED_BY'] = $_SESSION['PK_USER'];
		$HELP_SUB_CATEGORY['EDITED_ON'] = date("Y-m-d H:i");
		db_perform('DOA_M_HELP_SUB_CATEGORY', $HELP_SUB_CATEGORY, 'update'," PK_HELP_SUB_CATEGORY = '$_GET[id]'");
		$PK_HELP_SUB_CATEGORY = $_GET['id'];
	}
	header("location:manage_help_sub_category.php");
}
...
if($_GET['id'] == ''){
	...
	$res = $db->Execute("SELECT * FROM DOA_M_HELP_SUB_CATEGORY WHERE PK_HELP_SUB_CATEGORY = '$_GET[id]' ");
									...
									<div class="row">
                                        <div class="col-md-6">
											<div class="form-group m-b-40">
												...
												<span class="bar"></span>
												<input type="text" class="form-control required-entry" id="HELP_SUB_CATEGORY" name="HELP_SUB_CATEGORY" value="<?=$HELP_SUB_CATEGORY?>" required>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group m-b-40">
												...
												<span class="bar"></span>
												<select class="form-control" id="PK_HELP_CATEGORY" name="PK_HELP_CATEGORY" required="required">
									...
									<div class="row">
                                        <div class="col-md-12">
											<div class="form-group m-b-5"  style="text-align:center;" >
												...
												<button type="button" class="btn waves-effect waves-light" onclick="window.location.href='manage_help_sub_category.php'" >Cancel</button>
