            ...
            <tr>
                ...
                <td style="padding: 10px 0px 0px 0px;font-size: 20px;">
                    ...
                    <?php } else { ?>
                        ...
                        <?php } ?>&nbsp;&nbsp;
                        <a href="javascript:;" onclick="confirmDeleteUser(<?= $row->fields['PK_USER'] ?>);" title="Delete" style="color: red;"><i class="ti-trash"></i></a>
                </td>
            </tr>
        <?php $row->MoveNext();
            $i++;
...
<script>
    function confirmDeleteUser(PK_USER) {
        Swal.fire({
            title: 'Are you sure?',
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        Swal.fire(
                            ...
                            if (result.isConfirmed) {
                                showUserListByLocation(<?= $PK_LOCATION ?>);
                            }
                        });
                    }
                });
