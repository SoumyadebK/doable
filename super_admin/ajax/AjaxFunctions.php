...
function saveProfileInfoData($RESPONSE_DATA)
{
    ...
    $ACCOUNT_DATA['PK_BUSINESS_TYPE'] = 1;
    $ACCOUNT_DATA['PK_ACCOUNT_TYPE'] = 1;
    $ACCOUNT_DATA['FRANCHISE'] = 0;
    $ACCOUNT_DATA['BUSINESS_NAME'] = $RESPONSE_DATA['USER_NAME'];;
    $ACCOUNT_DATA['ADDRESS'] = $RESPONSE_DATA['ADDRESS'];
    $ACCOUNT_DATA['ADDRESS_1'] = $RESPONSE_DATA['ADDRESS_1'];
    $ACCOUNT_DATA['PK_COUNTRY'] = $RESPONSE_DATA['PK_COUNTRY'];
    $ACCOUNT_DATA['PK_STATES'] = $RESPONSE_DATA['PK_STATES'];
    $ACCOUNT_DATA['CITY'] = $RESPONSE_DATA['CITY'];
    $ACCOUNT_DATA['ZIP'] = $RESPONSE_DATA['ZIP'];
    $ACCOUNT_DATA['PHONE'] = $RESPONSE_DATA['PHONE'];
    //$ACCOUNT_DATA['FAX'] = $RESPONSE_DATA['FAX'];
    $ACCOUNT_DATA['EMAIL'] = $RESPONSE_DATA['EMAIL_ID'];
    //$ACCOUNT_DATA['WEBSITE'] = $RESPONSE_DATA['WEBSITE'];
    /* $ACCOUNT_DATA['TEXTING_FEATURE_ENABLED'] = $RESPONSE_DATA['TEXTING_FEATURE_ENABLED'] ?? 0;
    $ACCOUNT_DATA['TWILIO_ACCOUNT_TYPE'] = $RESPONSE_DATA['TWILIO_ACCOUNT_TYPE'];
    $ACCOUNT_DATA['USERNAME_PREFIX'] = $RESPONSE_DATA['USERNAME_PREFIX'];
    $ACCOUNT_DATA['FOCUSBIZ_API_KEY'] = $RESPONSE_DATA['FOCUSBIZ_API_KEY']; */
    $ACCOUNT_DATA['ENABLE_AI_VOICE_AGENT'] = $RESPONSE_DATA['ENABLE_AI_VOICE_AGENT'] ?? 0;
    $ACCOUNT_DATA['IS_CONCIERGE'] = $RESPONSE_DATA['IS_CONCIERGE'];
    ...
    $USER_DATA['TICKET_SYSTEM_ACCESS'] = isset($_POST['TICKET_SYSTEM_ACCESS']) ? $_POST['TICKET_SYSTEM_ACCESS'] : 0;
