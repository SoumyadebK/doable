...
if ($FUNCTION_NAME == 'loginFunction') {
    ...
    $result = $db->Execute("SELECT DOA_USERS.*, DOA_ACCOUNT_MASTER.DB_NAME, DOA_ACCOUNT_MASTER.ACTIVE AS ACCOUNT_ACTIVE, DOA_ACCOUNT_MASTER.IS_NEW FROM `DOA_USERS` LEFT JOIN DOA_ACCOUNT_MASTER ON DOA_USERS.PK_ACCOUNT_MASTER = DOA_ACCOUNT_MASTER.PK_ACCOUNT_MASTER WHERE DOA_USERS.EMAIL_ID = '$EMAIL_ID'");
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-material" id="loginform" action="" method="post">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" type="text" required="" placeholder="Email" id="EMAIL_ID" name="EMAIL_ID">
                            </div>
                        </div>
                        <div class="form-group">
