...
<header class="app-topbar">
    <div class="container-fluid topbar-menu">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="nav-links-elements xxx">
                        <ul class="nav navbar-nav">
                            <li class="">
                                <a class="nav-link <?= (('calendar.php' === $current_address || 'calendar_list_view.php' === $current_address) ? 'active' : '') ?>" href="../admin_v2/calendar.php">Calendar</a>
                            </li>
                            <li class="">
                            ...
                            <li class="dropdown drop-menu">
                                ...
                                <ul class="dropdown-menu sub-menu">
                                    <li><a href="../admin_v2/all_customers.php"><i class="bi bi-people" aria-hidden="true"></i> Customers</a></li>
                                    <li><a href="../admin_v2/all_enrollments.php"><i class="bi bi-journal-text" aria-hidden="true"></i> Enrollments</a></li>
                                </ul>
                            </li>
                            <li class="">
                                <a class="nav-link <?= (('payment_due_report.php' === $current_address) ? 'active' : '') ?>" href="../admin_v2/payment_due_report.php">Billing</a>
                            </li>
                            <li class="">
                                <a class="nav-link <?= (('all_leads.php' === $current_address) ? 'active' : '') ?>" href="../admin_v2/all_leads.php">Leads</a>
                            </li>
                            <li class="">
                                <a class="nav-link <?= (('all_events.php' === $current_address) ? 'active' : '') ?>" href="../admin_v2/all_events.php">Events</a>
                            </li>
                            <li class="">
                                <a class="nav-link <?= (('all_products.php' === $current_address) ? 'active' : '') ?>" href="../admin_v2/all_products.php">E-Commerce</a>
                            </li>
                            <li class="">
                                <a class="nav-link <?= (('reports.php' === $current_address) ? 'active' : '') ?>" href="../admin_v2/reports.php">Reports</a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="d-flex align-items-center" style="gap: 1.5rem !important;">
            ...
            <div class="topbar-item d-none d-sm-flex">
                <a class="top-bar-icon" href="../admin_v2/setup.php">
