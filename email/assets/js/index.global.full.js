    ...
    */
    ...
    class ToolbarSection extends BaseComponent {
        render() {
            ...
            return y('div', {
                className: 'fc-toolbar-chunk d-flex'
            }, ...children);
        }
                ...
                y(NowTimer, {
                    ...
                    return (y(_, null,
                        toolbarConfig.header && (y(Toolbar, Object.assign({
                            ref: this.headerRef,
                            extraClassName: "fc-header-toolbar mb-0 p-3",
...
/* ================================
   Booking Data – Added Automatically
   Source: Salsa Advanced card
================================ */

window.bookings = window.bookings || [];
window.bookings.push({
  id: "booking_salsa_advanced_001",
  title: "Salsa Advanced",
  start: "2024-10-03T13:30:00",
  end: "2024-10-03T14:10:00",
  instructor: "Chandler Bing",
  students: [
    { name: "Sophia Williams", phone: "(519) 000-1234", status: "Paid" },
    { name: "Anthony Williams", phone: "(519) 000-1234", status: "Paid" }
  ],
  notes: {
    public: "Remember to bring your dance shoes!",
    internal: "This is a short service provider-entered note about something to remember"
  }
});


/* =========================================
   FullCalendar Advanced Booking UI
========================================= */
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const calendar = new FullCalendar.Calendar(calendarEl, {
          ...
          <div class="booking-card">
            <div class="bc-header">
              ...
              <div class="bc-actions">
                <span class="bc-edit">✏️</span>
                <span class="bc-delete">🗑</span>
              </div>
            </div>
            <div class="bc-time">${arg.timeText}</div>
            <div class="bc-instructor">👤 ${arg.event.extendedProps.instructor}</div>
          </div>
        `
      };
    },
    ...
    eventClick: function (info) {
      const e = info.event;
      const students = (e.extendedProps.students || []).map(s => `
      ...
      document.getElementById('bookingModalBody').innerHTML = `
        <h5>${e.title}</h5>
        <p><strong>Time:</strong> ${e.start.toLocaleTimeString()} - ${e.end.toLocaleTimeString()}</p>
        <p><strong>Instructor:</strong> ${e.extendedProps.instructor}</p>
        <hr>
        <strong>${students.length ? e.extendedProps.students.length : 0} students</strong>
        ${students}
        <hr>
        <strong>Public note:</strong>
        <p>${e.extendedProps.notes?.public || ''}</p>
        <strong>Internal note:</strong>
        <p>${e.extendedProps.notes?.internal || ''}</p>
      `;
