...
function getSessionCreatedCount($PK_ENROLLMENT_SERVICE)
{
    ...
    if ($session_created->fields['SESSION_CREATED'] > 0) {
        ...
        $group_session_created = $db_account->Execute("SELECT COUNT(DOA_APPOINTMENT_MASTER.PK_APPOINTMENT_MASTER) AS SESSION_CREATED FROM DOA_APPOINTMENT_MASTER INNER JOIN DOA_APPOINTMENT_ENROLLMENT ON DOA_APPOINTMENT_MASTER.PK_APPOINTMENT_MASTER = DOA_APPOINTMENT_ENROLLMENT.PK_APPOINTMENT_MASTER WHERE (DOA_APPOINTMENT_MASTER.PK_APPOINTMENT_STATUS != 6 OR DOA_APPOINTMENT_MASTER.IS_CHARGED = 1) AND DOA_APPOINTMENT_MASTER.APPOINTMENT_TYPE = 'GROUP' AND TYPE = 'CREATED' AND DOA_APPOINTMENT_ENROLLMENT.PK_ENROLLMENT_SERVICE = ".$PK_ENROLLMENT_SERVICE);
...
function getSessionCompletedCount($PK_ENROLLMENT_SERVICE)
{
    ...
    if ($session_completed->RecordCount() > 0) {
        return $session_completed->fields['SESSION_COMPLETED'];
    } else {
        $group_session_completed = $db_account->Execute("SELECT COUNT(DOA_APPOINTMENT_MASTER.PK_APPOINTMENT_MASTER) AS SESSION_COMPLETED FROM DOA_APPOINTMENT_MASTER INNER JOIN DOA_APPOINTMENT_ENROLLMENT ON DOA_APPOINTMENT_MASTER.PK_APPOINTMENT_MASTER = DOA_APPOINTMENT_ENROLLMENT.PK_APPOINTMENT_MASTER WHERE DOA_APPOINTMENT_MASTER.IS_CHARGED = 1 AND DOA_APPOINTMENT_MASTER.APPOINTMENT_TYPE = 'GROUP' AND TYPE = 'COMPLETED' AND DOA_APPOINTMENT_ENROLLMENT.PK_ENROLLMENT_SERVICE = ".$PK_ENROLLMENT_SERVICE);
