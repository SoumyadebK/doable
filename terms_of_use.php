...
<head>
    ...
    <link href="assets/homepage/js/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="assets/homepage/js/owl-carousel/owl.theme.css" rel="stylesheet">
    <link rel="stylesheet" href="assets/homepage/js/parallax/main.css">
    <link rel="stylesheet" href="assets/homepage/fonts/pe-icon-7-stroke/css/pe-icon-7-stroke.css">
...
<body>
    ...
    <div class="wrapper-boxed">
        <div class="site-wrapper">
            <div class="col-md-12 nopadding">
                <div class="header-section style1 pin-style main-header">
                    <div class="container">
                        <div class="mod-menu">
                            <div class="row">
                                <div class="col-sm-3"> <a href="index.php" title="" class="logo style-2 mar-2"> <img height="80"
            ...
            <div class="header-inner-tmargin">
                <section class="section-side-image clearfix">
                    <div class="img-holder col-md-12 col-sm-12 col-xs-12">
                        <div class="background-imgholder" style="background:url(images/office-work.jpg);"><img
                                class="nodisplay-image" src="assets/homepage/images/office-work.jpg" alt="" /> </div>
                    </div>
                                ...
                                <div class="header-inner">
                                    <div class="overlay">
                                        <div class="text text-center">
                                            <h5 class="uppercase text-white less-mar-1 title">Terms of Use</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="sec-padding">
                <div class="container">
                    <div class="row">
                        <!-- <div class="col-md-6 margin-bottom"> <img src="http://via.placeholder.com/1000x800" alt="" class="img-responsive"/> </div> -->
                        <!--end item-->
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <div class="col-sm-12 nopadding">
                                <div class="sec-title-container less-padding-3 text-left">
                                    <h4 class="font-weight-6 less-mar-1 line-height-4">Effective March, 2023</h4>
                                    <div class="ce-title-line theme-title-line align-left"></div>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            <!--end title-->

                            <p>These Terms of Use ("Terms" or "Agreement") are a legal agreement between you and Doable LLC ("Doable," "we," "our," or "us") and govern your use of all text, data, information, software, graphics, calendars, images, and more that we may make available to you (all of which we refer to collectively as "Materials"), including our website, mobile application, and any services, software or other tools that we may provide through our website or mobile application (the "Website," or "Application" and together with the Materials, the "Services").</p>

                            <p>"Users" are people who have created a Doable account, people who have scheduled a meeting with a Doable account holder, people who visit the Website, and/or people who download the Application. If you are entering into these Terms on behalf of a company or other organization, you hereby represent and warrant that you are authorized to enter into these Terms on behalf of such company or other organization (an "Authorized User"). User or Authorized User may be referred to herein, as "you."</p>

                            <p>PLEASE READ THESE TERMS CAREFULLY BEFORE BROWSING THE WEBSITE OR DOWNLOADING THE APPLICATION. USING THE SERVICES INDICATES THAT YOU HAVE BOTH READ AND ACCEPT THESE TERMS. YOU CANNOT USE THE SERVICES IF YOU DO NOT ACCEPT THESE TERMS. THESE TERMS CONTAIN A DISCLAIMER OF WARRANTIES, LIMITATION OF LIABILITY, AND INDEMNIFICATION PROVISIONS THAT AFFECT YOUR RIGHTS UNDER THESE TERMS AND WITH RESPECT TO ANY DISPUTE YOU MAY HAVE WITH DOABLE.</p>

                            <h5>Scope.</h5>

                            <p>The Services facilitate the online scheduling of appointments and meetings. You may access and use the Services only in accordance with these Terms. When using the Services, you are subject to any applicable agreements, policies or guidelines that may be posted from time to time. All such agreements, policies or guidelines, including the <a href="privacy_policy.php" target="_blank">Privacy Policy</a>, are hereby incorporated by reference into these Terms.</p>

                            <h5>Purpose.</h5>

                            <p>You may use the Services for your individual purposes and not for the purposes of distribution or resale. Subject to these Terms, we grant you a limited, revocable, personal, non-exclusive, and non-transferable right to access and use the Services following the set-up of an account as set forth below. You have no other rights in the Services and shall not use the Services for any purposes beyond the scope of the access granted in this Agreement. User shall not at any time, directly or indirectly, and to the extent User is a company or other organization, shall not permit any Authorized Users to: (a) copy, modify, or create derivative works of the Services or Materials, in whole or in part; (b) rent, lease, lend, sell, license, sublicense, assign, distribute, publish, transfer, or otherwise make available the Services or Materials; (c) reverse engineer, disassemble, decompile, decode, adapt, or otherwise attempt to derive or gain access to any software component of the Services, in whole or in part; (d) remove any proprietary notices from the Services or Materials; or (e) knowingly use the Services or Materials in any manner or for any purpose that infringes, misappropriates, or otherwise violates any intellectual property right or other right of any person, or that violates any applicable law.</p>

                            <p>Subject to these Terms, we also grant you a limited, revocable, personal, non-exclusive, non-transferable subscription to access and use the Application.</p>
                            ...
                            <p>This Agreement may not be assigned by either party without the prior written consent of the other party, except in connection with the sale of all or substantially all of the assets or ownership interests of the party making the assignment. This Agreement shall be governed by the laws of the State of California, without regard to the conflict-of-laws provisions of such state. The parties hereby irrevocably submit to the exclusive jurisdiction of the courts of the State of California and any United States District Court situated in the State of California for the purpose of construing and enforcing this Agreement. The parties agree and acknowledge that Doable is an independent contractor of User and this Agreement shall not be deemed to create a partnership or joint venture. Doable may advertise or otherwise promote or divulge in any reasonable manner in its marketing efforts that User is a customer of Doable. Should a dispute between the parties arise in connection with this Agreement, the prevailing party shall be entitled to recover attorneys' fees in addition to any other recovery to which such party may be entitled. All notices given under this Agreement shall be in writing. Failure by a party to require performance by the other party or to claim a breach shall not be construed as a waiver of any right. All waivers must be in writing and signed by an authorized representative of the party making the waiver. This Agreement is the entire agreement between the parties and supersedes and terminates all prior agreements. Doable's obligations shall be excused without liability when prevented by strike, act of God, disease, pandemic, governmental action, accident, act of war, act of terrorism or any other condition beyond its reasonable control.</p>
                            ...
                            <!-- <br/>
            <br/>
            <a class="btn btn-dark btn-round uppercase" href="#">Read more</a> </div> -->
                            <!--end item-->
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-12 colmargin clearfix margin-bottom">
                            <div class="fo-map">
                                ...
                                <p class="text-light">Running a business is hard enough. You love what you do, but hate what you don't.
                                </p>
                        ...
                        <div class="col-md-3 col-xs-12 clearfix margin-bottom">
                            ...
                            <address class="text-light">
                                ...
                                1712 Pioneer Ave.<br>
                                Suite 783,<br>Cheyenne WY 82001,<br>
                                United States.
                            </address>
    ...
    <script src="assets/homepage/js/parallax/parallax-background.min.js"></script>
