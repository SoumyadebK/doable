                ...
                <ul id="sidebarnav" class="nav nav-pills" style="float: right;">
                    ...
                    <?php if (!in_array($_SESSION['PK_ROLES'], [1, 4, 5])) { ?>
                        ...
                        <li class="<?= (('all_leads.php' === $current_address) ? 'active' : '') ?>">
                            <a class="nav-link <?= (('all_leads.php' === $current_address) ? 'active' : '') ?>" href="../admin_v2/all_leads.php" aria-expanded="false">
                                <i class="icon-people"></i>
                                <span class="hide-menu">Leads</span>
                            </a>
                        </li>
                        <li class="<?= (('all_customers.php' === $current_address) ? 'active' : '') ?>">
                            <a class="nav-link <?= (('all_customers.php' === $current_address) ? 'active' : '') ?>" href="../admin_v2/all_customers.php" aria-expanded="false">
                                <i class="icons-User"></i>
                                <span class="hide-menu">Customers</span>
                            </a>
                        </li>
                        <li class="<?= (('all_enrollments.php' === $current_address) ? 'active' : '') ?>">
                            <a class="nav-link <?= (('all_enrollments.php' === $current_address) ? 'active' : '') ?>" href="../admin_v2/all_enrollments.php" aria-expanded="false">
                                <i class="icon-note"></i>
                                <span class="hide-menu">Enrollments</span>
                            </a>
                        </li>
                        <li class="<?= (('all_events.php' === $current_address) ? 'active' : '') ?>">
                            <a class="nav-link <?= (('all_events.php' === $current_address) ? 'active' : '') ?>" href="../admin_v2/all_events.php" aria-expanded="false">
