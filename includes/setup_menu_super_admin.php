            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light px-2 py-1 d-non">
                <div class="collapse col-6 navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <a class="dropdown-item" href="../super_admin/all_appointment_status.php">Appointment Type</a>
                    ...
                    <div style="margin-left: 15%;">
                        ...
                        <?php } elseif ($address == "all_enrollment_types.php" || $address == "all_agreement_types.php" || $address == "all_payment_types.php" || $address == "all_appointment_status.php" || $address == "all_interests.php" || $address == "all_document_types.php" || $address == "all_skill_levels.php" || $address == "all_relationship.php" || $address == "all_service_class.php" || $address == "all_frequency.php") { ?>
                            <ul class="nav nav-tabs justify-content-center">
                                ...
                                <li class="nav-item"><a class="nav-link" href="../super_admin/all_appointment_status.php">Appointment Type</a></li>
                        ...
                        <?php } elseif ($address == "all_chat_section.php") { ?>
                            <ul class="nav nav-tabs justify-content-center">
                                <li class="nav-item"><a class="nav-link" href="../super_admin/all_chat_section.php">Assistant</a></li>
                            </ul>
                        <?php } elseif ($address == "csv_uploader.php") { ?>
                            <ul class="nav nav-tabs justify-content-center">
