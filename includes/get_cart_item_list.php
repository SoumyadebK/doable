...
<div class="card-footer" style="text-align: center;">
    <a href="products_list.php" class="btn btn-success border-0 rounded-pill waves-effect waves-light text-white">Add Item to Cart</a>
    <?php if (isset($_SESSION['CART_DATA']) && count($_SESSION['CART_DATA']) > 0) { ?>
        <a href="product_checkout.php" class="btn btn-success border-0 rounded-pill waves-effect waves-light text-white">Checkout</a>
    <?php } ?>
</div>